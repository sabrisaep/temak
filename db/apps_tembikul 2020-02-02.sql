...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2020 at 12:32 PM
...
--
ALTER TABLE `bilik`
  MODIFY `idbilik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `kursus`
  MODIFY `idkursus` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
